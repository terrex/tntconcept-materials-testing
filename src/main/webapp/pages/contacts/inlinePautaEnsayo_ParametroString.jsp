...
<%-- List of ensayos --%>
<t:dataTable id="requerimientos" var="item" value="#{pautaEnsayoBean.requerimientos}" preserveDataModel="false"
    ...
    <h:column>
        <f:facet name="header">
            <t:commandLink action="#{pautaEnsayoBean.createRequerimiento}">
                <h:graphicImage title="#{msg.entityActions_new}" value="/img/new.gif" styleClass="cmdImg"/>
            </t:commandLink>
        </f:facet>
        <t:commandLink action="#{pautaEnsayoBean.deleteRequerimiento}"
    ...
    <h:column>
        ...
        <h:panelGroup>
            ...
            <h:inputText id="nombre" value="#{item.nombre}" size="30" required="true" styleClass="requiredFieldClass"/>
        </h:panelGroup>
