...
<%-- List of ensayos --%>
<t:dataTable id="dimensiones" var="item" value="#{pautaEnsayoBean.pautaEnsayo.dimensiones}"
             ...
             columnClasses="listCmdCell,editListEnsayoPautaEnsayo">

    <%-- Commands --%>
    <h:column>
        <f:facet name="header">
            <t:commandLink action="#{pautaEnsayoBean.createDimension}">
                <h:graphicImage title="#{msg.entityActions_new}" value="/img/new.gif" styleClass="cmdImg"/>
            </t:commandLink>
        </f:facet>
        <t:commandLink action="#{pautaEnsayoBean.deleteDimension}"
    ...
    <h:column>
        ...
        <f:facet name="header">
            <h:outputText value="*#{msg['pautaEnsayoDimension.name']}" styleClass="editListHeader"/>
        </f:facet>

        <h:panelGroup>
            <h:message styleClass="error" showSummary="true" showDetail="false" for="name"/>
            <h:inputText id="name" value="#{item.nombre}" size="40" required="true" styleClass="requiredFieldClass"/>
        </h:panelGroup>
    ...
    <h:column>
        ...
        <f:facet name="header">
            <h:outputText value="#{msg['pautaEnsayoDimension.valor']}" styleClass="editListHeader"/>
        </f:facet>
