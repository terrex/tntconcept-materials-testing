...
<i:titleBar msg="${msg}">
    <h:commandLink action="#{organizationBean.search}">
        <h:graphicImage rendered="#{ organizationBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                        value="/img/search_applied.gif" styleClass="titleImg"/>
        <h:graphicImage rendered="#{!organizationBean.search.searchActive}" title="#{msg.entityActions_search}"
                        value="/img/search.gif" styleClass="titleImg"/>
    </h:commandLink>
    <h:commandLink action="#{organizationBean.reset}">
        <h:graphicImage rendered="#{organizationBean.search.searchActive}" title="#{msg.entityActions_reset}"
...
<h:column>
    ...
    <t:commandLink action="#{organizationBean.editarPrecios}" immediate="true">
        <f:param name="id" value="#{organization.id}"/>
        <h:graphicImage title="#{msg.editarPrecios}" value="/img/dollar.png" styleClass="cmdImg"/>
    </t:commandLink>
    <t:commandLink action="#{organizationBean.duplicar}" immediate="true">
        <f:param name="id" value="#{organization.id}"/>
...
<h:column>
    <f:facet name="header">
        <t:commandSortHeader styleClass="listHeader" columnName="acronimo">
            <f:facet name="ascending">
                <t:graphicImage value="/img/ascending-arrow.gif" border="0"/>
            </f:facet>
            <f:facet name="descending">
            ...
            <f:verbatim>${msg['organization.acronimo']}</f:verbatim>
        </t:commandSortHeader>
    </f:facet>
    ...
    <t:commandLink action="#{organizationBean.detail}" immediate="true">
        <f:param name="id" value="#{organization.id}"/>
        <%-- String field --%>
        <h:outputText value="#{organization.acronimo}"/>
    </t:commandLink>
