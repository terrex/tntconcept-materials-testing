...
<f:view>
    ...
    <h:form id="interactionType" enctype="multipart/form-data">
        ...
        <i:titleBar name="${interactionTypeBean.name}" msg="${msg}">
            <h:commandLink action="#{interactionTypeBean.save}"
                           onclick="if(!askSave('#{interactionTypeBean.id}','#{msg['question.confirmSave']}')) return false;">
                <h:graphicImage title="#{msg.entityActions_save}" value="/img/save.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{interactionTypeBean.delete}"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="name" value="#{interactionTypeBean.name}" maxlength="128" required="true"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputTextarea id="description" value="#{interactionTypeBean.description}" rows="5"
                                         cols="68"/>
                    </h:panelGroup>
