...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="offerState" value="#{offerBean.searchOfferState}"
                             onclick="setEnabled('search:offerState',true)">
...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="offerPotential" value="#{offerBean.searchOfferPotential}"
                             onclick="setEnabled('search:offerPotential',true)">
                <f:converter converterId="autentia.EnumConverter"/>
...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="organization" value="#{offerBean.searchOrganization}"
...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="offerRejectReason" value="#{offerBean.searchOfferRejectReason}"
                             onclick="setEnabled('search:offerRejectReason',true)">
    ...
    <%-- Field: lineaTrabajo --%>
<tr>
    <td class="searchLabel">${msg['offer.lineaTrabajo']}:</td>
    <td class="searchFieldCell">
        <h:panelGroup>
            <h:message styleClass="error" showSummary="true" showDetail="false" for="lineaTrabajo"/>
            <h:selectBooleanCheckbox id="lineaTrabajoValid" value="#{offerBean.searchLineaTrabajoValid}"
                                     onclick="setEnabled('search:lineaTrabajo',this.checked)"/>
            <h:selectOneMenu id="lineaTrabajo" value="#{offerBean.searchLineaTrabajo}"
        ...
        <script>
            setEnabled('search:lineaTrabajo', ${offerBean.searchLineaTrabajoValid})
        </script>
    </td>
</tr>
