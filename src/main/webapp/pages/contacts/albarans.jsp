...
<!-- albarans.jsp: generated by stajanov code generator -->
<f:loadBundle basename="com.autentia.intra.resources.messages" var="msg"/>
<i:location place="albarans" msg="${msg}"/>
...
<f:view>
    ...
    <h:form id="albarans">
        ...
        <%-- Header --%>
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{albaranBean.search}">
                <h:graphicImage rendered="#{ albaranBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!albaranBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{albaranBean.reset}">
                <h:graphicImage rendered="#{albaranBean.search.searchActive}" title="#{msg.entityActions_reset}"
        ...
        <div class="abcPager">
            ...
            <a:abcPager styleClass="abcPagerLetter" selectedStyleClass="abcPagerSelectedLetter"
                        value="#{albaranBean.letter}" action="#{albaranBean.letterClicked}"
                        allowUnselect="true" unselectImage="/img/no_funnel.png"/>
        </div>


        <%-- List of albarans --%>
        <t:dataTable id="list" var="albaran" value="#{albaranBean.all}" preserveDataModel="false"
                     ...
                     columnClasses="listCmdCell,listAlbaranNombre,listAlbaranFecha,listAlbaranNumero"
                     sortColumn="#{albaranBean.sortColumn}" sortAscending="#{albaranBean.sortAscending}"
            ...
            <h:column>
                ...
                <t:commandLink action="#{albaranBean.detail}" immediate="true">
                    <f:param name="id" value="#{albaran.id}"/>
            ...
            <h:column>
                ...
                <t:commandLink action="#{albaranBean.detail}" immediate="true">
                    <f:param name="id" value="#{albaran.id}"/>
                    <%-- Referenced field --%>
                    <h:outputText value="#{albaran.name}"/>
            ...
            <h:column>
                ...
                <t:commandLink action="#{albaranBean.detail}" immediate="true">
                    <f:param name="id" value="#{albaran.id}"/>
                    <%-- Date field --%>
                    <h:outputText value="#{albaran.fecha}" converter="autentia.dateConverter"/>
