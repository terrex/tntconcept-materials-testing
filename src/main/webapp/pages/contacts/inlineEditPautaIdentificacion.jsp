...
<t:dataTable id="identificacionesCliente" var="item" value="#{pautaBean.pauta.referenciasCliente}"
             ...
             columnClasses="listCmdCell,editListPautaEnsayo">

    <%-- Commands --%>
    <h:column>
        <f:facet name="header">
            <t:commandLink action="#{pautaBean.createIdentificacionCliente}">
                <h:graphicImage title="#{msg.entityActions_new}" value="/img/new.gif" styleClass="cmdImg"/>
            </t:commandLink>
        </f:facet>
        <t:commandLink action="#{pautaBean.deleteIdentificacionCliente}"
