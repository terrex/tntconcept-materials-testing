    ...
    <h:form id="contacts">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{contactBean.search}">
                <h:graphicImage rendered="#{ contactBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!contactBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{contactBean.reset}">
                <h:graphicImage rendered="#{contactBean.search.searchActive}" title="#{msg.entityActions_reset}"
        ...
        <t:dataTable id="list" var="contact" value="#{contactBean.all}" preserveDataModel="false"
                     ...
                     columnClasses="listCmdCell,listContactName,listContactEmail,listContactPhone,listContactMobile,listContactOrganization"
            ...
            <h:column>
                ...
                <t:commandLink action="#{contactBean.detail}" immediate="true">
                    <f:param name="id" value="#{contact.id}"/>
                    <%-- Referenced field --%>
                    <h:outputText value="#{contact.organization.name}"/>
