...
<f:view>
    ...
    <h:form id="companyState" enctype="multipart/form-data">
        ...
        <i:titleBar name="${companyStateBean.creationDate}" msg="${msg}">
            <t:commandLink action="#{companyStateBean.edit}" immediate="true"
                           rendered="#{companyStateBean.editAvailable}">
                <f:param name="id" value="#{companyStateBean.id}"/>
                <h:graphicImage title="#{msg.entityActions_edit}" value="/img/edit.gif" styleClass="cmdImg"/>
            </t:commandLink>
            <h:commandLink action="#{companyStateBean.delete}" rendered="#{companyStateBean.deleteAvailable}"
