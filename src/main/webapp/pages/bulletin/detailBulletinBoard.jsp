...
<f:view>
    ...
    <h:form id="bulletinBoard" enctype="multipart/form-data">
        ...
        <i:titleBar name="${bulletinBoardBean.title}" msg="${msg}">
            <t:commandLink action="#{bulletinBoardBean.edit}" immediate="true"
                           rendered="#{bulletinBoardBean.editAvailable}">
                <f:param name="id" value="#{bulletinBoardBean.id}"/>
                <h:graphicImage title="#{msg.entityActions_edit}" value="/img/edit.gif" styleClass="cmdImg"/>
            </t:commandLink>
            <h:commandLink action="#{bulletinBoardBean.delete}" rendered="#{bulletinBoardBean.deleteAvailable}"
