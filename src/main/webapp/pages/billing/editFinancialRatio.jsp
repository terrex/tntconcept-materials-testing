...
<i:titleBar name="${financialRatioBean.title}" msg="${msg}">
    ...
    <h:commandLink action="#{financialRatioBean.delete}"
...
<tr>
    ...
    <td class="editFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:inputText id="title" value="#{financialRatioBean.title}" size="70" required="true"
...
<tr>
    ...
    <td class="editFieldCell">
        ...
        <h:panelGroup>
            ...
            <t:inputCalendar id="ratioDate" value="#{financialRatioBean.ratioDate}" required="true"
                             styleClass="requiredFieldClass"
        ...
        <tr>
            ...
            <td class="detailLabelRatiosAsset">
                <h:panelGroup>
                    ...
                    <h:inputText id="banksAccounts" value="#{financialRatioBean.banksAccounts}" size="12"
                                 required="true"
                                 styleClass="requiredFieldClass">
        ...
        <tr>
            ...
            <td class="detailLabelRatiosAsset">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="customers" value="#{financialRatioBean.customers}" size="12" required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
                        <f:attribute name="maxSize" value="10"/>
        ...
        <tr>
            ...
            <td class="detailLabelRatiosAsset">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="stocks" value="#{financialRatioBean.stocks}" size="12" required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
                        <f:attribute name="maxSize" value="10"/>
        ...
        <tr>
            ...
            <td class="detailLabelRatiosAsset">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="amortizations" value="#{financialRatioBean.amortizations}" size="12"
                                 required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
        ...
        <tr>
            ...
            <td class="detailLabelRatiosAsset">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="infrastructures" value="#{financialRatioBean.infrastructures}" size="12"
                                 required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
        ...
        <tr>
            ...
            <td class="detailLabelRatiosLia">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="shortTermLiability" value="#{financialRatioBean.shortTermLiability}" size="12"
        ...
        <tr>
            ...
            <td class="detailLabelRatiosLia">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="obligationBond" value="#{financialRatioBean.obligationBond}" size="12"
                                 required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
        ...
        <tr>
            ...
            <td class="detailLabelRatiosLia">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="capital" value="#{financialRatioBean.capital}" size="12" required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
                        <f:attribute name="maxSize" value="10"/>
        ...
        <tr>
            ...
            <td class="detailLabelRatiosLia">
                ...
                <h:panelGroup>
                    ...
                    <h:inputText id="reserves" value="#{financialRatioBean.reserves}" size="12" required="true"
                                 styleClass="requiredFieldClass">
                        <f:validator validatorId="autentia.genericMoneyValidator"/>
                        <f:attribute name="scale" value="2"/>
                        <f:attribute name="maxSize" value="10"/>
            ...
            <tr>
                ...
                <td class="detailLabelRatiosRes">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="incomes" value="#{financialRatioBean.incomes}" size="12" required="true"
                                     styleClass="requiredFieldClass">
                            <f:validator validatorId="autentia.genericMoneyValidator"/>
                            <f:attribute name="scale" value="2"/>
                            <f:attribute name="maxSize" value="10"/>
            ...
            <tr>
                ...
                <td class="detailLabelRatiosRes">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="expenses" value="#{financialRatioBean.expenses}" size="12" required="true"
                                     styleClass="requiredFieldClass">
                            <f:validator validatorId="autentia.genericMoneyValidator"/>
                            <f:attribute name="scale" value="2"/>
                            <f:attribute name="maxSize" value="10"/>
                ...
                <td class="detailLabelRatiosRes">
                    ...
                    <h:panelGroup>
                        <h:message styleClass="error" showSummary="true" showDetail="false"
                                   for="otherExploitationExpenses"/>
                        <h:inputText id="otherExploitationExpenses"
                                     value="#{financialRatioBean.otherExploitationExpenses}"
            ...
            <tr>
                ...
                <td class="detailLabelRatiosRes">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="financialExpenses" value="#{financialRatioBean.financialExpenses}" size="12"
                                     required="true" styleClass="requiredFieldClass">
                            <f:validator validatorId="autentia.genericMoneyValidator"/>
                            <f:attribute name="scale" value="2"/>
                            <f:attribute name="maxSize" value="10"/>
            ...
            <tr>
                ...
                <td class="detailLabelRatiosRes">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="taxes" value="#{financialRatioBean.taxes}" size="12" required="true"
                                     styleClass="requiredFieldClass">
                            <f:validator validatorId="autentia.genericMoneyValidator"/>
                            <f:attribute name="scale" value="2"/>
                            <f:attribute name="maxSize" value="10"/>
