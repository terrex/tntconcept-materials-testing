...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:inputText id="startExpiration" value="#{billBean.searchStartExpiration}" size="31"/>
        </h:panelGroup>
        -
        <h:panelGroup>
            ...
            <h:inputText id="endExpiration" value="#{billBean.searchEndExpiration}" size="31"/>
        </h:panelGroup>
        <script>
...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="paymentMode" value="#{billBean.searchPaymentMode}"
                             onclick="setEnabled('search:paymentMode',true)">
...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="provider" value="#{billBean.searchProvider}"
                             onclick="setEnabled('search:provider',true)">
    ...
    <%-- Field: client --%>
<tr>
    <td class="searchLabel">${msg['bill.client']}:</td>
    <td class="searchFieldCell">
        <h:panelGroup>
            <h:message styleClass="error" showSummary="true" showDetail="false" for="client"/>
            <h:selectBooleanCheckbox id="clientValid" value="#{billBean.searchClientValid}"
                                     onclick="setEnabled('search:client',this.checked)"/>
            <h:selectOneMenu id="client" value="#{billBean.searchClient}"
                             onclick="setEnabled('search:client',true)">
                <f:selectItems value="#{billBean.clients}"/>
                <f:converter converterId="autentia.EntityConverter"/>
            </h:selectOneMenu>
        </h:panelGroup>
        <script>
            setEnabled('search:client', ${billBean.searchClientValid})
        </script>
...
<tr>
    ...
    <td class="searchFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:selectOneMenu id="organization" value="#{billBean.selectedOrganization}" immediate="true"
                             onchange="submit()"
                             valueChangeListener="#{billBean.onSelectedOrganizationSearchChanged}"
                             onclick="setEnabled('search:organization',true);setEnabled('search:project',true)">
                <f:selectItems value="#{billBean.organizations}"/>
                <f:converter converterId="autentia.EntityConverter"/>
            </h:selectOneMenu>
            <h:selectOneMenu id="project" value="#{billBean.searchProject}"
                             onclick="setEnabled('search:organization',true);setEnabled('search:project',true)">
...
<tr>
    ...
    <%-- Field: lineaTrabajo --%>
<tr>
    <td class="searchLabel">${msg['bill.lineaTrabajo']}:</td>
    <td class="searchFieldCell">
        <h:panelGroup>
            <h:message styleClass="error" showSummary="true" showDetail="false" for="lineaTrabajo"/>
            <h:selectBooleanCheckbox id="lineaTrabajoValid" value="#{billBean.searchLineaTrabajoValid}"
                                     onclick="setEnabled('search:lineaTrabajo',this.checked)"/>
            <h:selectOneMenu id="lineaTrabajo" value="#{billBean.searchLineaTrabajo}"
                             onclick="setEnabled('search:lineaTrabajo',true)">
                <f:selectItems value="#{billBean.lineaTrabajos}"/>
                <f:converter converterId="autentia.EntityConverter"/>
            </h:selectOneMenu>
        </h:panelGroup>
        <script>
            setEnabled('search:lineaTrabajo', ${billBean.searchLineaTrabajoValid})
        </script>
    </td>
</tr>
