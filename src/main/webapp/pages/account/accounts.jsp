    ...
    <h:form id="accounts">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{accountBean.search}">
                <h:graphicImage rendered="#{ accountBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!accountBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{accountBean.reset}">
                <h:graphicImage rendered="#{accountBean.search.searchActive}" title="#{msg.entityActions_reset}"
