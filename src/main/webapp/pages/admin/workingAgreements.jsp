    ...
    <h:form id="workingAgreements">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{workingAgreementBean.search}">
                <h:graphicImage rendered="#{ workingAgreementBean.search.searchActive}"
        ...
        <t:dataTable id="list" var="workingAgreement" value="#{workingAgreementBean.all}" preserveDataModel="false"
                     ...
                     sortColumn="#{workingAgreementBean.sortColumn}"
                     sortAscending="#{workingAgreementBean.sortAscending}"
            ...
            <h:column>
                ...
                <t:commandLink action="#{workingAgreementBean.detail}" immediate="true">
                    <f:param name="id" value="#{workingAgreement.id}"/>
