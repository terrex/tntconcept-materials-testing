...
<f:view>
    ...
    <h:form id="setting" enctype="multipart/form-data">
        ...
        <i:titleBar name="${settingBean.name}" msg="${msg}">
            <h:commandLink action="#{settingBean.save}"
                           onclick="if(!askSave('#{settingBean.id}','#{msg['question.confirmSave']}')) return false;">
                <h:graphicImage title="#{msg.entityActions_save}" value="/img/save.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{settingBean.delete}"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="name" value="#{settingBean.name}" size="70" maxlength="200" required="true"
