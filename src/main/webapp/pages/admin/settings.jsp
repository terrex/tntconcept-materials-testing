    ...
    <h:form id="settings">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{settingBean.search}">
                <h:graphicImage rendered="#{ settingBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!settingBean.search.searchActive}" title="#{msg.entityActions_search}"
