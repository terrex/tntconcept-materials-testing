    ...
    <h:form id="departments">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{departmentBean.search}">
                <h:graphicImage rendered="#{ departmentBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!departmentBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{departmentBean.reset}">
                <h:graphicImage rendered="#{departmentBean.search.searchActive}" title="#{msg.entityActions_reset}"
