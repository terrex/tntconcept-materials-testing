    ...
    <h:form id="userCategorys">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{userCategoryBean.search}">
                <h:graphicImage rendered="#{ userCategoryBean.search.searchActive}"
                                title="#{msg.entityActions_filtered}" value="/img/search_applied.gif"
                                styleClass="titleImg"/>
                <h:graphicImage rendered="#{!userCategoryBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{userCategoryBean.reset}">
                <h:graphicImage rendered="#{userCategoryBean.search.searchActive}" title="#{msg.entityActions_reset}"
        ...
        <t:dataTable id="list" var="userCategory" value="#{userCategoryBean.all}" preserveDataModel="false"
            ...
            <h:column>
                ...
                <t:commandLink action="#{userCategoryBean.detail}" immediate="true">
                    <f:param name="id" value="#{userCategory.id}"/>
