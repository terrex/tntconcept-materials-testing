...
<i:titleBar name="${inventaryBean.description}" msg="${msg}">
    ...
    <h:commandLink action="#{inventaryBean.delete}"
...
<tr>
    ...
    <td class="editFieldCell">
        ...
        <h:panelGroup>
            ...
            <t:inputCalendar id="buyDate" value="#{inventaryBean.buyDate}" required="true"
...
<tr>
    ...
    <td class="editFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:inputText id="cost" value="#{inventaryBean.cost}" size="10" maxlength="11" required="true"
                         styleClass="requiredFieldClass">
...
<tr>
    ...
    <td class="editFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:inputText id="amortizable" value="#{inventaryBean.amortizable}" required="true"
                         styleClass="requiredFieldClass"/>
        </h:panelGroup>
...
<tr>
    ...
    <td class="editFieldCell">
        ...
        <h:panelGroup>
            ...
            <h:inputText id="serialNumber" value="#{inventaryBean.serialNumber}" size="20" maxlength="30"
