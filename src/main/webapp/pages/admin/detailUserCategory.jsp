...
<f:view>
    ...
    <h:form id="userCategory" enctype="multipart/form-data">
        ...
        <i:titleBar name="${userCategoryBean.name}" msg="${msg}">
            <t:commandLink action="#{userCategoryBean.edit}" immediate="true"
                           rendered="#{userCategoryBean.editAvailable}">
            ...
            <h:commandLink action="#{userCategoryBean.delete}" rendered="#{userCategoryBean.deleteAvailable}"
