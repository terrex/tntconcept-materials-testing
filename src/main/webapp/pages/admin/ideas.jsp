    ...
    <h:form id="ideas">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{ideaBean.search}">
                <h:graphicImage rendered="#{ ideaBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!ideaBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{ideaBean.reset}">
                <h:graphicImage rendered="#{ideaBean.search.searchActive}" title="#{msg.entityActions_reset}"
