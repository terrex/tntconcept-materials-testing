...
<f:view>
    ...
    <h:form id="activity">
        ...
        <t:div styleClass="progressBar"
               style="background-position: #{250 * (-2 + activityBean.monthPerformedHours / activityBean.monthTotalHours)}px center;z-index:0;"
            ...
            <h:outputText value="#{activityBean.monthPerformedHours / activityBean.monthTotalHours}"
                          styleClass="progressBarText">
