    ...
    <h:form id="magazines">
        ...
        <i:titleBar msg="${msg}">
            <h:commandLink action="#{magazineBean.search}">
                <h:graphicImage rendered="#{ magazineBean.search.searchActive}" title="#{msg.entityActions_filtered}"
                                value="/img/search_applied.gif" styleClass="titleImg"/>
                <h:graphicImage rendered="#{!magazineBean.search.searchActive}" title="#{msg.entityActions_search}"
                                value="/img/search.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{magazineBean.reset}">
                <h:graphicImage rendered="#{magazineBean.search.searchActive}" title="#{msg.entityActions_reset}"
        ...
        <t:dataTable id="list" var="magazine" value="#{magazineBean.all}" preserveDataModel="false"
            ...
            <h:column>
                ...
                <t:commandLink action="#{magazineBean.detail}" immediate="true">
                    <f:param name="id" value="#{magazine.id}"/>
