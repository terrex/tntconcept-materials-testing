...
<f:view>
    ...
    <h:form id="magazine" enctype="multipart/form-data">
        ...
        <i:titleBar name="${magazineBean.name}" msg="${msg}">
            ...
            <h:commandLink action="#{magazineBean.delete}"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="name" value="#{magazineBean.name}" size="70" maxlength="128" required="true"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputTextarea id="description" value="#{magazineBean.description}" rows="5" cols="68"
