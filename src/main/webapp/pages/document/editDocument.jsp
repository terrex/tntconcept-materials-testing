...
<f:view>
    ...
    <h:form id="editDocument" enctype="multipart/form-data">
        ...
        <i:titleBar name="${documentBean.name}" msg="${msg}">
            <h:commandLink action="#{documentBean.save}"
                           onclick="if(!askSave('#{documentBean.id}','#{msg['question.confirmSave']}')) return false;">
                <h:graphicImage title="#{msg.entityActions_save}" value="/img/save.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink rendered="#{documentBean.id!=null}" action="#{documentBean.delete}"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="name" value="#{documentBean.name}" size="70" maxlength="256" required="true"
