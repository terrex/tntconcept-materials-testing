    ...
    <h:form id="billReports">
        ...
        <h:panelGrid columns="2" cellpadding="0" cellspacing="0" styleClass="editTable"
            ...
            <h:selectOneMenu id="billReport" value="#{billReportBean.selectedReport}"
                             ...
                             valueChangeListener="#{billReportBean.selectedReportChanged}" onchange="submit();">
        ...
        <h:dataTable id="params" var="reportParameter"
            ...
            <h:column id="label">
                <h:outputText value="*#{reportParameter.label}:"
                              rendered="#{reportParameter.hiddenType != true and reportParameter.required}"></h:outputText>
                <h:outputText value="#{reportParameter.label}:"
                              rendered="#{reportParameter.hiddenType != true and !reportParameter.required}"></h:outputText>
            </h:column>
            ...
            <h:column id="data">
                ...
                <h:panelGroup id="text" rendered="#{reportParameter.textType == true}">
                    <h:inputText value="#{reportParameter.value}" size="20"
                                 required="#{reportParameter.required}"></h:inputText>
                </h:panelGroup>
                ...
                <h:panelGroup id="date" rendered="#{reportParameter.dateType == true}">
                    ...
                    <t:inputCalendar id="paramDate" renderPopupButtonAsImage="true"
                                     ...
                                     renderAsPopup="true"
                                     popupDateFormat="dd/MM/yyyy" required="#{reportParameter.required}"
                ...
                <h:panelGroup id="selectOnes" rendered="#{reportParameter.selectOneType == true}">
                    <h:selectOneMenu id="selectOne" value="#{reportParameter.value}"
                ...
                <h:panelGroup id="selectManys" rendered="#{reportParameter.selectManyType == true}">
                    <h:selectManyListbox size="8" id="selectMany" value="#{reportParameter.valueMany}"
                                         required="#{reportParameter.required}">
                        <f:selectItems value="#{reportParameter.items}"/>
                    </h:selectManyListbox>
                </h:panelGroup>
