...
<f:view>
    ...
    <h:form id="userHolidayState">
        ...
        <h:panelGrid columns="3" cellpadding="0" cellspacing="0" styleClass="editTable"
            ...
            <h:commandButton action="#" title="#{msg['userHolidayState.show']}"
        ...
        <t:dataTable id="list" var="userHolidaysState" value="#{userHolidaysStateBean.all}" preserveDataModel="false"
                     ...
                     rowClasses="listRowO,listRowE" sortColumn="#{userHolidaysStateBean.sortColumn}"
                     sortAscending="#{userHolidaysStateBean.sortAscending}"
