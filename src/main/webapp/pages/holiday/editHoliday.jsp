...
<f:view>
    ...
    <h:form id="holiday" enctype="multipart/form-data">
        ...
        <i:titleBar name="${holidayBean.description}" msg="${msg}">
            <h:commandLink action="#{holidayBean.save}"
                           onclick="if(!askSave('#{holidayBean.id}','#{msg['question.confirmSave']}')) return false;">
                <h:graphicImage title="#{msg.entityActions_save}" value="/img/save.gif" styleClass="titleImg"/>
            </h:commandLink>
            <h:commandLink action="#{holidayBean.delete}"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="description" value="#{holidayBean.description}" maxlength="1024"
            ...
            <tr>
                ...
                <td class="editFieldCell">
                    ...
                    <h:panelGroup>
                        ...
                        <t:inputCalendar id="date" value="#{holidayBean.date}" required="true"
