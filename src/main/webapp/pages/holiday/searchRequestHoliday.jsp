    ...
    <tr>
        ...
        <td class="searchFieldCell">
            ...
            <h:panelGroup>
                ...
                <h:selectBooleanCheckbox id="startBeginDateValid"
                                         value="#{requestHolidayBean.searchStartBeginDateValid}"
    ...
    <tr>
        ...
        <td class="searchFieldCell">
            ...
            <h:panelGroup>
                ...
                <h:selectBooleanCheckbox id="startFinalDateValid"
                                         value="#{requestHolidayBean.searchStartFinalDateValid}"
    ...
    <tr>
        ...
        <td class="searchFieldCell">
            ...
            <h:panelGroup>
                ...
                <h:selectOneMenu id="state" value="#{requestHolidayBean.searchState}"
                                 onclick="setEnabled('search:state',true)">
    ...
    <tr>
        ...
        <td class="searchFieldCell">
            ...
            <h:panelGroup>
                ...
                <h:selectBooleanCheckbox id="startChargeYearValid"
                                         value="#{requestHolidayBean.searchStartChargeYearValid}"
