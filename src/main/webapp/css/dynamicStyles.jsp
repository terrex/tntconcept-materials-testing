...
.activitysTable {
/* Table to layout list of activities on top and activity detail on bottom */
    width: 100%;
    height: 40%;
    border-spacing: 0px;
}

.activitysCalendarCell {
/* Cell containing the calendar */
    width: 1%;
    height: 1%;
    vertical-align: top;
}
...
.activitysListCell {
/* Cell containing the activities list */
    width: 99%;
    height: 1%;
    vertical-align: top;
}
