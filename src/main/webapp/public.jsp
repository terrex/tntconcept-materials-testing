...
<h:form id="idMessages">
            ...
            <td class="bullTopCenterBack">
                <div class="bullTopCenterFore">
                      <span class="bullTopCenterTitle">
                        Tabl&oacute;n de anuncios p&uacute;blico
                      </span>
                </div>
            </td>
    ...
    <f:verbatim>
        ...
        <tr>
        <td class="msgLabel">Creado por:</td>
        <td class="msgValue">
    </f:verbatim>
    ...
    <f:verbatim>
        ...
        Optimizado para 1024x768 a pantalla completa (F11)<br>
        TNTConcept version
    </f:verbatim><h:outputText value="#{applicationBean.build}"/><f:verbatim> Copyright (C) 2007 Autentia Real Business
    Solution S.L.
