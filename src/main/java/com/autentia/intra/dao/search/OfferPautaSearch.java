...
public class OfferPautaSearch extends SearchCriteria {
...
/* generated by stajanov (do not edit/delete) */
    ...
    public String getHQL() {
        ...
        if (isPautaSet()) {
            ...
            if (getPauta() == null) {
                ret.append("pauta is NULL");
            } else {
                ret.append("pauta = :arg" + (iArgNum++));
            }
        }
        ...
        if (isUnidadesSet()) {
            ret.append((ret.length() == 0) ? "WHERE " : " AND ");
            if (getUnidades() == null) {
                ret.append("unidades is NULL");
            } else {
                ret.append("unidades = :arg" + (iArgNum++));
            }
        }
    ...
    public Object[] getArguments() {
        ...
        if (isUnidadesSet() && getUnidades() != null) {
            ret.add(unidades);
        }
    ...
    public void setUnidades(Integer unidades) {
        ...
        this.unidadesSet = true;
    }

    public void unsetUnidades() {
        this.unidadesSet = false;
    }
    ...
    public boolean isSearchActive() {
        return customIsSearchActive() || pautaSet || costSet || unidadesSet || ownerIdSet || departmentIdSet || startInsertDateSet || endInsertDateSet || startUpdateDateSet || endUpdateDateSet || offerSet;
    }
