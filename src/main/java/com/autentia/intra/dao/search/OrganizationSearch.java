...
/* generated by stajanov (do not edit/delete) */
    ...
    public String getHQL() {
        ...
        if (isNumeroProveedorSet()) {
            ret.append((ret.length() == 0) ? "WHERE " : " AND ");
            if (numeroProveedor == null) {
                ret.append("numeroProveedor is NULL");
            } else {
                ret.append("numeroProveedor = :arg" + (iArgNum++));
            }
        }
        ...
        if (isColumnaRefCliSet()) {
            ret.append((ret.length() == 0) ? "WHERE " : " AND ");
            if (getColumnaRefCli() == null) {
                ret.append("columnaRefCli is NULL");
            } else {
                ret.append("columnaRefCli = :arg" + (iArgNum++));
            }
        }
    ...
    public Object[] getArguments() {
        ...
        if (isNumeroProveedorSet() && getNumeroProveedor() != null) {
            ret.add(numeroProveedor);
        }
        ...
        if (isColumnaRefCliSet() && getColumnaRefCli() != null) {
            ret.add(columnaRefCli);
        }
    ...
    public boolean isNumeroProveedorSet() {
        return numeroProveedorSet;
    }
    ...
    public void setNumeroProveedor(String numeroProveedor) {
        ...
        this.numeroProveedorSet = true;
    }

    public void unsetNumeroProveedor() {
        this.numeroProveedorSet = false;
    }
    ...
    public boolean isColumnaRefCliSet() {
        return columnaRefCliSet;
    }
    ...
    public void setColumnaRefCli(String columnaRefCli) {
        ...
        this.columnaRefCliSet = true;
    }

    public void unsetColumnaRefCli() {
        this.columnaRefCliSet = false;
    }
    ...
    private boolean numeroProveedorSet;
    ...
    private boolean columnaRefCliSet;
    ...
    public boolean isSearchActive() {
        return customIsSearchActive() || nameSet || cifSet || streetSet || numberSet || numeroProveedorSet || locatorSet || postalCodeSet || citySet || stateSet || countrySet || phoneSet || faxSet || emailSet || websiteSet || ftpsiteSet || notesSet || columnaRefCliSet || ownerIdSet || departmentIdSet || startInsertDateSet || endInsertDateSet || startUpdateDateSet || endUpdateDateSet || typeSet || categorySet || provinceSet;
    }
