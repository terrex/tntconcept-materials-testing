...
public class ProductoPrecioSearch extends SearchCriteria {
...
/* generated by stajanov (do not edit/delete) */
    ...
    public String getHQL() {
        ...
        if (isProductoSet()) {
            ...
            if (getProducto() == null) {
                ret.append("producto is NULL");
            } else {
                ret.append("producto = :arg" + (iArgNum++));
            }
        }
    ...
    public Object[] getArguments() {
        ...
        if (isProductoSet() && getProducto() != null) {
            ret.add(producto);
        }
    ...
    public String toString() {
        StringBuilder ret = new StringBuilder();
        ret.append("ProductoPrecioSearch{");
    ...
    public void setProducto(String producto) {
        ...
        this.productoSet = true;
    }

    public void unsetProducto() {
        this.productoSet = false;
    }
    ...
    public boolean isSearchActive() {
        return customIsSearchActive() || productoSet || clientSet || costSet || ownerIdSet || departmentIdSet || startInsertDateSet || endInsertDateSet || startUpdateDateSet || endUpdateDateSet;
    }
